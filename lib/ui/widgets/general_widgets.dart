...
Widget divider3Widht() => const SizedBox(width: 3,);
Widget divider6Widht() => const SizedBox(width: 6,);
Widget divider10Widht() => const SizedBox(width: 10,);
Widget divider20Widht() => const SizedBox(width: 20,);
